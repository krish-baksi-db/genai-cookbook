...
# successful call
translate_sku_tool._run(old_sku="OLD-XXX-1234")

# COMMAND ----------

# unsuccessful call
translate_sku_tool._run(old_sku="OxxLD-XXX-1234")
...
# MAGIC     UC_FUNCTION_NAME = "krish_db.cookbook_local_test.sku_sample_translator"
...
python_exec_tool._run(code="print('hello')")
