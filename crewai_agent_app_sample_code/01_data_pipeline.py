...
source_config = UCVolumeSourceConfig(
    ...
    uc_catalog_name="dev", # REPLACE_ME
...
output_config = DataPipelineOuputConfig(
    ...
    vector_search_endpoint="one-env-shared-endpoint-17", # Vector Search endpoint to store the index
    ...
    version_suffix="v4"                     # default is None
...
is_error, msg, e = retriever_index_result = build_retriever_index(
